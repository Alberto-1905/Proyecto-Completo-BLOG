...
<html lang="en">
	<head>
		...
		<style type="text/css"> 
			#banner{
				background-image: url('https://punto.mx/wp-content/uploads/2022/04/jurassic.jpg'); 
			}		
		</style>
	...
	<body>
		...
		<div class="banner" id="banner">
			<div class="banner-contenedor">
				<center><h1 class="banner-titulo">Jurassic World: Dominio</h1>

				<div class="botones">
				<button class="hd">Duración: 02h 27m.</button>
				</div>
		...
		<div class="video-contenedor">
			<div class="video">
				...
				scrolling="no" src="https://media.esplay.one/player?sbx=1&ref=pelisplusio&hash=U2FsdGVkX1%2Bh7HxDRoft8VvMPNmMwkmTg4YwRDGKEDLaexiPwY87iNZpefwXAHIC" style="background-color: black; border-color: #fff; border-radius: 10px; border-style: solid; border-width: 2px;" width="97%"></iframe></center>	
			</div>
		</div>
