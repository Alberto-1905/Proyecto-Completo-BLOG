...
<html lang="en">
	<head>
		...
		<style type="text/css"> 
			#banner{
				background-image: url('https://areajugones.sport.es/wp-content/uploads/2020/02/The-Batman-w.jpg'); 
			}		
		</style>
	...
	<body>
		...
		<div class="video-contenedor">
			<div class="video">
				...
				scrolling="no" src="https://media.esplay.one/player?sbx=1&ref=pelisplusio&hash=U2FsdGVkX1%2BRPymTwRCHW0UPTNNnP5Z0kq00ML5Ry3%2F%2BsK%2Bp8%2B2zJ7%2F9pg3leA4b" style="background-color: black; border-color: #fff; border-radius: 10px; border-style: solid; border-width: 2px;" width="97%"></iframe></center>	
			</div>
		</div>
